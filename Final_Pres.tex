...
\begin{definition}[Dynamical System]\label{sec:org96ff22d}
...
\begin{definition}[Function Iteration]\label{sec:org3870eeb}
\(f^0 := \symbf{I}\)
...
\begin{definition}[Complex Numbers]\label{sec:org393f7cf}
\(\symbf{i}^2 = -1\)
...
\begin{frame}[label={sec:org95931e4}]{Complex Iteration}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{block}{Rules}
\(f(z) = z^2\)
...
\begin{frame}[label={sec:orgd3d488b}]{Complex Iteration}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{block}{Rules}
...
\begin{frame}[label={sec:orge5a5ed1}]{Group Activity}
\(f(z) = z^2 + c\)
...
\begin{frame}[label={sec:orgcd41b31}]{Group Activity (Easier)}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{block}{Rules}
\(f(z) = z^2 + c\)
...
\begin{frame}[label={sec:orgcb3e169},b]{Quaternions History}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{figure}[htbp]
...
\begin{frame}[label={sec:orgde70f8c}]{Quaternions}
\begin{definition}[Quaternion]\label{sec:orgaab595a}
